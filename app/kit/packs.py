...
DESIGNER_PACKS: list[DesignerPack] = [
    DesignerPack(
        ...
        action="Создать узор",
        name="Полоса узоров",
        description="Целая полоса: волны, фестоны, меандр, ромбы, розетки, лоза, рамка врезки — каждый блок отдельным Group",
    ...
    DesignerPack(
        ...
        description="Несколько вариантов врезок: орнаментальная рамка, оранжевая, бирюзовая, с уголками",
