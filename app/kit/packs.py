...
DESIGNER_PACKS: list[DesignerPack] = [
    DesignerPack(
        ...
        action="Создать узор",
        name="Полоса узоров",
        description="Целая полоса: 10 блоков — волны, фестоны, меандр, ромбы, линейки, розетки, лоза, лента, рамка, комбо",
        needs="Ничего прикладывать не нужно. Подпись для рамки — по желанию (например «В эти дни»).",
    ...
    DesignerPack(
        ...
        name="Красивые подложки",
        description="Полоса подложек: орнамент, оранжевая, бирюзовая, уголки, цитата, лента, виньетка — Copy/Paste Group",
